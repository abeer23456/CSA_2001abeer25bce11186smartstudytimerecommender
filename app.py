...
def create_dataset():
 data={"difficulty":[1,2,3,4,5,5,4,3,2,1,5,4,2,3,1,4,5,3,2,4],"days_left":[15,12,10,7,3,2,5,8,14,20,1,4,11,6,18,9,2,7,13,5],"preparation":[5,4,3,2,1,2,3,4,5,4,1,2,4,3,5,2,1,3,4,2],"importance":[1,2,3,4,5,5,4,3,2,1,5,4,2,3,1,4,5,3,2,4],"study_hours":[1,2,4,7,12,11,8,5,2,1,13,9,3,6,1,8,12,5,2,7]}
...
def predict_study_time(model,difficulty,days_left,preparation,importance):
 input_data=pd.DataFrame({"difficulty":[difficulty],"days_left":[days_left],"preparation":[preparation],"importance":[importance]})
...
def main():
 ...
 for i in range(1,num_subjects+1):
  ...
  results.append({"Subject":subject_name,"Difficulty":difficulty,"Days Left":days_left,"Preparation":preparation,"Importance":importance,"Recommended Study Time (hours)":hours,"Priority":priority,"Advice":advice})
